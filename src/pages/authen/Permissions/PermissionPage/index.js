      ...
      <div>
        <section className='card'>
          <div className='card-header'>
            ...
            <small>
              You manage access for users by creating permissions and attaching them to users or
              groups. A permission is an object, when associated with an entity or resource, defines
              their permissions. We evaluates these permissions when a principal, such as a user,
              makes a request. Permissions in the permissions determine whether the request is
              allowed or denied. Most permissions are stored in cloud as JSON documents.
            </small>
            <p>
              <small>
                We define permissions for an action regardless of the method that you use to perform
                the operation. For example, if a permission allows the GetUser action, then a user
                with that permission can get user information. When you create a user, you can set
                up the user to allow console or programmatic access. The user can sign in to the
