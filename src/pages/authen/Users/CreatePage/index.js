          ...
          <div className="card-header">
            <div className="card-header">
              ...
              <Divider orientation="left">
                <h4>
                  Step {this.props.steps[current].index + 1}: {this.props.steps[current].title}
                </h4>
              </Divider>
            </div>
          </div>
          ...
          <div className="card-body">
            ...
            <div className="col-md-12 text-right">
              <ButtonGroup className="">
                ...
                {current > 0 && current < this.props.steps.length - 1 && (
                  <Button type="default" onClick={() => this.changeStep(-1)}>
                    <Icon type="left" /> Previous
                  </Button>
                )}
                {current < this.props.steps.length && (
                  <Button
                  ...
                  >
                    {this.props.steps[current].nextTitle}
                    <Icon type="right" />
                  </Button>
                )}
              </ButtonGroup>
