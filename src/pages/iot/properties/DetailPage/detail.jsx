    ...
    return (
      <div className='property property-detail-page row'>
        <div className='col-lg-4 text-justify'>
          <p>Property management is the application of processes, methods, knowledge, skills and experience to achieve the property objectives.</p>
        </div>
        <div className='col-lg-8'>
          ...
          <div className='form-group'>
            <label htmlFor='group-edit-title'>Property Color</label>
            <div className='row'>
          ...
          <div className='form-group'>
            <label htmlFor='group-edit-title'>Property Description</label>
            <TextArea
              rows={4}
              value={description}
