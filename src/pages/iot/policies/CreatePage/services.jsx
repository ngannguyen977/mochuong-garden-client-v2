...
class ServicePage extends React.Component {
  ...
  render() {
    ...
    return (
      <div className='policy-create sevice-step row'>
        <div className='col-lg-4 text-justify'>
          ...
          <p>Please choose a service then you can see the list actions of that service. You only choose 1 service for a policy. Go to the next step: SELECT ACTIONS.</p>
        </div>
