        ...
        <section className='card'>
          <div className='card-header'>
            ...
            <small>
              ...
              their policies. We evaluates these policies when a principal, such as a user,
              makes a request. Policies in the policies determine whether the request is
              allowed or denied. Most policies are stored in cloud as JSON documents.
            </small>
            <p>
              <small>
                We define policies for an action regardless of the method that you use to perform
                the operation. For example, if a policy allows the GetUser action, then a user
                with that policy can get user information. When you create a user, you can set
