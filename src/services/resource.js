...
export const getServices = (keyword, keysort, skip, count, orderDescending = true) => new Promise((resolve, reject) => {
    instance.get(serviceApi, {
...
export const getActions = (shortname) => new Promise((resolve, reject) => {
    instance
